                        ...
                        <div class="row g-0 rounded-top">
                            <div class="d-flex flex-row comment-row m-t-0 align-items-center rounded-top" style="background-color: #dd163b;">
                                <div class="p-2" id="comentarioCliente1">
                                    <img src="assets/img/otho.png" alt="Vendedor" width="40" class="rounded-circle">
                                </div>
                            ...
                            <div class="col-md-6 post-padd">
                                <img src="assets/img/foto1.jpg" class="img-fluid rounded-1" alt="...">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="col-md-8">
                            <div class="card-body card-text-color">
                                ...
                                <div class="col">
                                    ...
                                    <div>
                                        <p id="comentarioCliente1">
                                            <img src="assets/img/otho.png" class="rounded-circle" style="width: 33px;" alt="">
                                            Confira também nossas Camisetas e Calças na promoção!!! Segue pra mais
                                        </p>
                                        <span id="pontos"></span>
                                        <span id="mais">
                                            <p id="comentarioCliente">
                                                <img src="assets/img/otho.png" class="rounded-circle" style="width: 33px;" alt=""> Qual o preço?
                                            </p>
                                            <p id="comentarioCliente">
                                                <img src="assets/img/otho.png" class="rounded-circle" style="width: 33px;" alt="">Tem tamanho M?
                                            </p>
                                        </span>
