...
if (!empty($_POST)) {
  ...
  if ($senha_usuario == $confsenha_usuario) {
    ...
    try {
      $stmt = $conn->prepare("INSERT INTO tb_cadastro_usuario(nome_usuario, email_usuario, senha_usuario, cd_usuario) 
      VALUES (:nome_usuario, :email_usuario, :senha_usuario, :cd_usuario)");
